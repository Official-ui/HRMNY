...
function screenCheckout(t) {
  ...
  return scr('co-' + t.id, '',
    ...
    `<div class="paychip" style="margin-top:10px"><span class="pc-ic"></span><div class="pc-t">Visa •••• 4242<small>Processed by Stripe</small></div><span class="ck" style="margin-left:auto">✓</span></div>` +
...
function screenLicenseDetail(l) {
  ...
  return scr('lic-' + l.id, '',
    ...
    `<div class="dl-done dl-${l.id}-done"><span class="ck">✓</span> Saved to your files — <b>${fileName(t)}</b> + <b>license.pdf</b></div>` +
...
function screenUp3() {
  return scr('up3', '',
    ...
    `<div class="attest signed" style="margin-top:16px"><div style="font-size:14px;line-height:1.6">“I, <b>Mara Vance</b>, made <b>Midnight Drive</b> as a human work. No part was generated by AI. I authorize HRMNY to license it on my behalf under the terms I set.”</div>` +
      `<div class="at-sig"><span class="ck">✓</span> Ready to sign · sig will be recorded on submit</div></div>` +
...
function screenWallet() {
  ...
  return scr('wallet', '',
    ...
    `<div class="earn" style="margin-top:14px"><div class="e-lab">Available to pay out</div>` +
      ...
      `<div class="payout-done"><span class="ck">✓</span> $612 on its way to •••• 4471 · arrives in ~2 days</div></div>` +
